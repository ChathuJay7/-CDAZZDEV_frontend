...
export default function EditPPostForm({ id, title, description }) {
  ...
  return (
    <form className='flex flex-col gap-5 mt-5 justify-center items-center bg-slate-200 py-10' onSubmit={handleSubmit}>
        ...
        <textarea className='border border-slate-500 px-8 py-2 w-[80%]' onChange={(e) => setNewDescription(e.target.value)} value={newDescription} type='text' placeholder='Topic Description'/>
